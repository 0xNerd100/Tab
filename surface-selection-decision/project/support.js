...
;(() => {
  ...
  function Placeholder({ name, hintSize, streaming, error }) {
    ...
    return h(
      'div',
      {
        ...
        style: { width: w.trim(), height: hgt?.trim() },
        title: name,
      },
      error
  ...
  function hintToMin(hint) {
    ...
    return { minWidth: w.trim(), minHeight: hgt?.trim() }
  }
