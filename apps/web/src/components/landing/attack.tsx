  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1240, margin: '0 auto' }}>
        ...
        <h2
          className="t-display"
          style={{ fontSize: 'clamp(32px,4.6vw,68px)', margin: '0 0 40px', maxWidth: '20ch' }}
        >
        ...
        <div className="attack-grid">
          ...
          >
            <svg
              ...
              role="img"
              aria-label="The ceiling collapses to zero and the next spend is refused"
            >
              ...
              <text
                ...
                fontSize={11}
                fill="var(--rail-fg-mute)"
              >
                ZERO
              </text>
              <path
                d="M24 120 C 120 120 150 176 232 190 C 300 202 340 176 392 150"
                fill="none"
                stroke="#F0846C"
                strokeWidth={7}
                strokeLinecap="round"
              ...
              <line
                ...
                stroke="#9DB4F7"
                strokeWidth={2.5}
                style={{ transition: 'y1 var(--settle), y2 var(--settle)' }}
              />
              <text
                x={596}
                y={ceilY - 6}
          ...
          >
            ...
            <div style={{ padding: '20px 22px 26px' }}>
              ...
              <p style={{ fontSize: 16, lineHeight: 1.65, margin: '0 0 18px', maxWidth: '52ch' }}>
                ...
                refused. The agent funded this seller two hops back, so the purchase would be
                self-dealing and the revenue would not be real.
              </p>
              <div
                className="t-mono"
                style={{
        ...
        >
          The graph caught a seller the agent controls. The ceiling collapsed mid-window and the
          next spend was refused. The float was never touched.
        </p>

        <div style={{ borderTop: 'var(--bw) solid var(--paper)', paddingTop: 32 }}>
          <h3 className="t-display" style={{ fontSize: 32, margin: '0 0 8px' }}>
          ...
          >
            {OPEN_GAPS.map((g) => (
              <div
                key={g.title}
                style={{ border: 'var(--bw) solid var(--caution)', borderRadius: 2, padding: 20 }}
              >
                <div
                  style={{
                    display: 'flex',
                ...
                >
                  <span className="t-display-700" style={{ fontSize: 19 }}>
                    {g.title}
                  </span>
                  <span
                    className="chip"
