    ...
    <>
      <header className="site-head">
        ...
        <nav className="site-nav">
          ...
          <Link href="/docs" style={{ color: 'var(--ink-2)', textDecoration: 'none' }}>
            Docs
          </Link>
        </nav>
      ...
      <section className="hero rule-b">
        <HeroScene>
          ...
          <svg
            ...
            role="img"
            aria-label="Tab — a credit rail for autonomous agents on Hedera"
          >
            {/* A decorative-looking hero still needs a name: a screen reader
                otherwise announces an unlabelled graphic in the first thing on
                the page. */}
            <title>Tab — a credit rail for autonomous agents on Hedera</title>
            <g stroke="var(--rule-soft)" strokeWidth={1} opacity={0.7}>
              <path d="M0 470 L1200 470" />
              <path d="M0 510 L1200 510" />
              <path d="M0 560 L1200 560" />
              <path d="M0 620 L1200 620" />
              <path d="M0 692 L1200 692" />
              <path d="M120 470 L40 692" />
              <path d="M300 470 L280 692" />
              <path d="M480 470 L520 692" />
              <path d="M660 470 L760 692" />
              <path d="M840 470 L1000 692" />
              <path d="M1020 470 L1240 692" />
            </g>
        ...
        <div className="hero-copy">
          ...
          >
            ...
            positive when it earns, and settles once per window in a single transfer. The agent
            never holds USDC and never signs a payment.
          </p>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 14, marginBottom: 28 }}>
            <Link href="/docs" className="btn btn-primary">
              Read the docs
            </Link>
            <Link href="/app/tab" className="btn">
              Open the app
            </Link>
          </div>
      ...
      >
        <div style={{ maxWidth: 1240, margin: '0 auto' }}>
          <h2
            className="t-display"
            style={{ fontSize: 'clamp(32px,4.6vw,68px)', margin: '0 0 20px', maxWidth: '20ch' }}
          >
          ...
          >
            ...
            structurally behind its earning capacity, and the only fix on offer is to fund a wallet
            first.
          </p>
          <div
            style={{
          ...
          >
            {PROBLEMS.map((p) => (
              ...
              >
                <div className="t-label" style={{ color: 'var(--caution)' }}>
                  {p.idx}
                </div>
                <h3 className="t-display-700" style={{ fontSize: 24, margin: 0 }}>
                  {p.title}
                </h3>
                <p style={{ fontSize: 14, lineHeight: 1.7, color: 'var(--rule-soft)', margin: 0 }}>
                  {p.body}
                </p>
      ...
      <section id="engine" className="rule-b" style={{ padding: '88px 28px' }}>
        <div style={{ maxWidth: 1240, margin: '0 auto' }}>
          <h2
            className="t-display"
            style={{ fontSize: 'clamp(32px,4.4vw,68px)', margin: '0 0 44px', maxWidth: '22ch' }}
          >
          ...
          <div className="engine-grid">
            <div className="card" style={{ padding: 26 }}>
              <div className="t-mono" style={{ fontSize: 12.5, lineHeight: 2.2 }}>
                ...
                <Term op="×" note="A 3.0 · B 2.0 · C 1.0 · Unrated 0">
                  tier_multiple
                </Term>
                <Term op="×" note="starts 15%, +15% clean, −30% missed">
                  ramp_factor
                </Term>
      ...
      <section className="rule-b" style={{ padding: '88px 28px' }}>
        <div style={{ maxWidth: 1240, margin: '0 auto' }}>
          <h2
            className="t-display"
            style={{ fontSize: 'clamp(32px,4.4vw,68px)', margin: '0 0 40px', maxWidth: '18ch' }}
          >
          ...
          >
            {HEDERA_REASONS.map((h) => (
              ...
              >
                <div className="t-figure" style={{ fontSize: 32, color: 'var(--pen)' }}>
                  {h.figure}
                </div>
                <div className="t-display-700" style={{ fontSize: 19 }}>
                  {h.title}
                </div>
      ...
      {/* ── CLOSE ────────────────────────────────────────────────────────── */}
      <section
        style={{ background: 'var(--ink)', color: 'var(--paper)', padding: '88px 28px 40px' }}
      >
          ...
          <div>
            ...
            >
              <div
                ...
                style={{
                  background: 'var(--deep)',
                  borderBottom: 'var(--bw) solid var(--paper)',
                  padding: '7px 14px',
                  display: 'flex',
              ...
              <pre
                className="t-mono"
                style={{ margin: 0, padding: 14, fontSize: 14, color: 'var(--paper)' }}
              >
            ...
            >
              {NOT_BUILT.map((n) => (
                <li
                  ...
                  style={{
                    padding: '11px 0',
                    borderBottom: '1px solid var(--rail-rule)',
                    display: 'flex',
                    gap: 12,
                    alignItems: 'baseline',
                  }}
        ...
        <div
          ...
          style={{
            maxWidth: 1240,
            margin: '56px auto 0',
            borderTop: 'var(--bw) solid var(--paper)',
            paddingTop: 20,
            display: 'flex',
            flexWrap: 'wrap',
            gap: 20,
        ...
        >
          <a
            href="https://github.com/TechnicallyKiller/ethonline-1"
